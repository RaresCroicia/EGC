...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices = {
            ...
            VertexFormat(glm::vec3(0.5,  1,  0.5), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6))
        };
    ...
    // opposing vertex orientations.
    {
        ...
        CreateMesh("squareHalf", vertices, indices);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["squareHalf"], shaders["VertexColor"], glm::vec3(0, 0.5f, 1.5f), glm::vec3(0.25f));
